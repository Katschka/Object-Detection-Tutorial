""" usage: trained_object_detection.py [-h] [-f FILETYPE] [-i IMAGE_PATH] [-l LABEL_PATH] [-m MODEL_PATH]
...
parser.add_argument(
  ...
  type=str,
  default="/home/$USER/TensorFlow/workspace/training_demo/images/detect"
  )
...
parser.add_argument(
  ...
  type=str,
  default="/home/$USER/TensorFlow/workspace/training_demo/annotations/label_map.pbtxt"
)
...
parser.add_argument(
  ...
  type=str,
  default="/home/$USER/TensorFlow/workspace/training_demo/exported-models/demo_model/saved_model"
)
